CREATE TABLE phong_may (
	ma_phong INT CONSTRAINT PK_phong_may PRIMARY KEY,
	ten_phong VARCHAR(100),
	ten_nguoi_quan_ly_phong VARCHAR(100)
);

CREATE TABLE may_tinh (
	ma_may INT CONSTRAINT PK_may_tinh PRIMARY KEY,
	toc_do_CPU FLOAT,
...
CREATE TABLE dang_ky (
	...
	ma_phong INT,
	CONSTRAINT FK_dang_ky_phong_may FOREIGN KEY(ma_phong) REFERENCES phong_may(ma_phong),
	ngay_dang_ky DATE,
